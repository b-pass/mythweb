...
?>
	    ...
	    <div class="x-pixmap">Video Preview:<br />
	    <video autoplay='false' preload='none' height='<?=$flv_h?>' width='<?=$flv_w?>' style="outline: 1px solid grey ;" controls>
	      <source src="<?php echo root_url."preview.php?f=".urlencode(basename($program->filename))."&width={$flv_w}"; ?>" type="video/mp4">
